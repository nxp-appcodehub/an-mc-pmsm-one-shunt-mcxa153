...
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16A, FMSTR_TSA_FRAC16) /* Duty cycle A */
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16B, FMSTR_TSA_FRAC16) /* Duty cycle B */
FMSTR_TSA_RW_VAR(g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16C, FMSTR_TSA_FRAC16) /* Duty cycle C */
