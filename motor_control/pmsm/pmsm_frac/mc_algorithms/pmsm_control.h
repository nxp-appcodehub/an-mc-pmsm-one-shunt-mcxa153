...
typedef struct _mcs_pmsm_foc_a1
{
    ...
    GMCLIB_SVMSTDSHIFTED_T_F16 sPhaseShiftParams;
	GMCLIB_ADC_CONFIG_T_F16 sADCConfig;
	GMCLIB_PWM_CONFIG_T_F16 sPWMConfig;
    GMCLIB_PHASE_INDEX_T eSmplOnePh_Last;
    GMCLIB_PHASE_INDEX_T eSmplTwoPh_Last;
    GMCLIB_PHASE_INDEX_T eCalcPh_Last;
    ...
    frac16_t f16IDcOffset;                    /* DC bus current offset*/
    frac16_t f16IDcOffsetFilt;                /* Filtered DC bus current offset */
    uint16_t ui16PwmModuleHalf;
