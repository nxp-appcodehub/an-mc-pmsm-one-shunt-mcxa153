...
#define M1_SVM_SECTOR_DEFAULT 1 /* default SVM sector */
...
static void M1_StateInitFast(void)
{
    ...
    /* Phase shift */
    g_sM1Drive.sFocPMSM.sPhaseShiftParams.f16LowerLim = FRAC16(0.09);
    g_sM1Drive.sFocPMSM.sPhaseShiftParams.f16UpperLim = FRAC16(0.91);
	g_sM1Drive.sFocPMSM.sPhaseShiftParams.f16MinT1T2 = FRAC16(0.06);
    ...
    g_sM1Drive.sFocPMSM.ui16PwmModuleHalf = FLEXPWM0->SM[0].VAL1;

    /* Clear rest of variables  */
    M1_ClearFOCVariables();

    /* Init sensors/actuators pointers */
    M1_SET_PTR_DUTY(g_sM1Drive.sFocPMSM.sPWMConfig.sDuty);
...
static void M1_StateStopFast(void)
{
    ...
    g_sM1Drive.sFocPMSM.sADCConfig.f16SmplFirstEdge = FRAC16(-0.66);
    g_sM1Drive.sFocPMSM.sADCConfig.f16SmplSecondEdge = FRAC16(-0.33);
...
static void M1_StateRunFast(void)
{
	...
	FLEXPWM0->SM[0].VAL2 = MLIB_Mul_F16(MLIB_SubSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16A,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16A),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);
	FLEXPWM0->SM[1].VAL2 = MLIB_Mul_F16(MLIB_SubSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16B,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16B),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);
	FLEXPWM0->SM[2].VAL2 = MLIB_Mul_F16(MLIB_SubSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16C,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16C),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);

	FLEXPWM0->SM[0].VAL3 = MLIB_Mul_F16(MLIB_AddSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16A,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16A),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);
	FLEXPWM0->SM[1].VAL3 = MLIB_Mul_F16(MLIB_AddSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16B,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16B),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);
	FLEXPWM0->SM[2].VAL3 = MLIB_Mul_F16(MLIB_AddSat_F16(g_sM1Drive.sFocPMSM.sPWMConfig.sShift.f16C,g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16C),g_sM1Drive.sFocPMSM.ui16PwmModuleHalf);

    FLEXPWM0->SM[0].VAL4 = MLIB_Mul_F16(g_sM1Drive.sFocPMSM.sADCConfig.f16SmplFirstEdge,g_sM1Drive.sFocPMSM.ui16PwmModuleHalf)-192;
    FLEXPWM0->SM[0].VAL5 = MLIB_Mul_F16(g_sM1Drive.sFocPMSM.sADCConfig.f16SmplSecondEdge,g_sM1Drive.sFocPMSM.ui16PwmModuleHalf)-192;

    /* Update duty, edge shift and DC bus current sampling point */
    FLEXPWM0->MCTRL |= PWM_MCTRL_LDOK_MASK;
...
static void M1_TransFaultStop(void)
{
	...
	g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16A = FRAC16(0.5);
	g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16B = FRAC16(0.5);
	g_sM1Drive.sFocPMSM.sPWMConfig.sDuty.f16C = FRAC16(0.5);
}
...
static void M1_StateRunAlignFast(void)
{
    ...
    if(0U == g_sM1Drive.sSpeed.f16SpeedCmd)
    {
...
static void M1_StateRunStartupFast(void)
{
    ...
    if ((0 == g_sM1Drive.sSpeed.f16SpeedCmd ) && (g_sM1Drive.eControl == kControlMode_SpeedFOC))
    {
