...
/*
{
    ...
    "sensors": {
        ...
        "sensorEncDir": 1,
        "sensorEncNmin": 0,
        "sensorObsrvParSampleTime": 0.000125,
...
/*
{
    ...
    "motorDescription": "Configuration for LINIX motor. 8k fast loop"
}
*/
...
#define M1_FAULT_DURATION (2500)
#define M1_FREEWHEEL_DURATION (1500)
#define M1_SCALAR_UQ_MIN FRAC16(0.0284877)
#define M1_ALIGN_VOLTAGE FRAC16(0.0284877)
#define M1_ALIGN_DURATION (3200)
#define M1_UDCB_IIR_B0 FRAC32(0.0188930)
#define M1_UDCB_IIR_B1 FRAC32(0.0188930)
#define M1_UDCB_IIR_A1 FRAC32(0.462214)
...
#define M1_SCALAR_RAMP_UP FRAC32(0.000170455)
#define M1_SCALAR_RAMP_DOWN FRAC32(0.000170455)
/* CURRENTLOOP*/
#define M1_D_KP_GAIN ACC32(0.156389)
#define M1_D_KI_GAIN ACC32(0.0134610)
#define M1_Q_KP_GAIN ACC32(0.233650)
#define M1_Q_KI_GAIN ACC32(0.0171018)
#define M1_CLOOP_LIMIT FRAC16(0.9)
/* SPEEDLOOP*/
#define M1_SPEED_RAMP_UP FRAC32(0.00136364)
#define M1_SPEED_RAMP_DOWN FRAC32(0.00136364)
...
#define M1_SPEED_PI_INTEG_GAIN ACC32(0.000446804)
...
#define M1_POSPE_TO_THETA_SHIFT (-5)
#define M1_POSPE_TO_THETA_GAIN FRAC16(0.586667)
/* SENSORLESS*/
#define M1_OL_START_RAMP_INC FRAC32(0.0000852273)
#define M1_OL_START_I FRAC16(0.0727273)
#define M1_MERG_SPEED_TRH FRAC16(0.113636)
#define M1_MERG_COEFF FRAC16(0.00312500)
#define M1_I_SCALE ACC32(0.854266)
#define M1_U_SCALE ACC32(1.12742)
#define M1_E_SCALE ACC32(0.484977)
#define M1_WI_SCALE ACC32(0.125020)
#define M1_BEMF_DQ_KP_GAIN ACC32(0.529570)
#define M1_BEMF_DQ_KI_GAIN ACC32(0.0977900)
#define M1_TO_KP_SHIFT (0)
#define M1_TO_KP_GAIN FRAC16(0.818182)
#define M1_TO_KI_SHIFT (-5)
#define M1_TO_KI_GAIN FRAC16(0.616895)
#define M1_TO_THETA_SHIFT (-4)
#define M1_TO_THETA_GAIN FRAC16(0.586667)
#define M1_TO_SPEED_IIR_B0 FRAC32(0.0678776)
#define M1_TO_SPEED_IIR_B1 FRAC32(0.0678776)
#define M1_TO_SPEED_IIR_A1 FRAC32(0.364245)
/* USER INPUT START */
#define AA 1
#define BB 3
#define CC 4
